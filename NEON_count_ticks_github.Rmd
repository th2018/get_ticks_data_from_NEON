...
```{r}
files<-list.files("C:/Users/gis/Downloads/get_ticks_data_from_NEON-master/filesToStack10093/output")
...
```{r}
setwd("C:/Users/gis/Downloads/get_ticks_data_from_NEON-master/filesToStack10093/output")
